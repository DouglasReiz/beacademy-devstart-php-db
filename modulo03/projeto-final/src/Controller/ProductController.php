...
class ProductController extends AbstractController
{
    ...
    public function removeAction(): void
    {
        ...
        parent::renderMessage('Pronto, excluído');
    }
    ...
    public function reportAction(): void
    {
        ...
        $result = $con -> prepare('SELECT prod.id, prod.name, prod.quantity, cat.name as category FROM tb_product prod INNER JOIN tb_category cat ON prod.categoria_id = cat.id');
        $result -> execute();
